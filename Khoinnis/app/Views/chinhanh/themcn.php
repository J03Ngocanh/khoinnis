...
<h2>THÊM CHI NHÁNH</h2>
    <form action="<?php echo WEBROOT . 'chinhanh/xulythem' ?>" method="POST">
        <!-- Nhóm Mã Chi Nhánh, Tên Chi Nhánh và SĐT vào một dòng -->
        <div class="form-group">
            <div class="form-item">
                <label for="TenChiNhanh">Tên Chi Nhánh:</label>
                <input type="text" id="TenChiNhanh" name="TenChiNhanh" value="" required>
            </div>
            <div class="form-item">
                <label for="SoDienThoai">Số Điện Thoại:</label>
                <input type="text" id="SoDienThoai" name="SoDienThoai" value="" required>
            </div>
        </div>
        <br>
        <label for="DiaChi">Địa Chỉ:</label>
        <input type="text" id="DiaChi" name="DiaChi" value="" required><br>
